...
<<<<<<< HEAD
    ...
    void Awake()
    {
        ...
        arrayOfPedestrianNodes[0].canSpawn = true;
    ...
    public void GenerateNodesOn_skrzyzowanie_2jezdniowe(ElementDrogi element)// funkcja do generowania i łączenia nodów na droga_2jezdniowa
    {
        ...
        List<Vector3> vectorsList = new List<Vector3>();// lista do przechowywanie pozycji względnej każdego noda
        vectorsList.Add(new Vector3(37.5f, 2, 3));//0
        vectorsList.Add(new Vector3(7f, 2, 3));//1
        vectorsList.Add(new Vector3(3.5f, 2, 4));//2
        vectorsList.Add(new Vector3(3, 2, 8));//3
        vectorsList.Add(new Vector3(3, 2, 37.5f));//4
        vectorsList.Add(new Vector3(-3, 2, 37.5f));//5
        vectorsList.Add(new Vector3(-3, 2, 8));//6
        vectorsList.Add(new Vector3(-4, 2, 4));//7
        vectorsList.Add(new Vector3(-7, 2, 2));//8
        vectorsList.Add(new Vector3(-37.5f, 2, 2));//9
        vectorsList.Add(new Vector3(-37.5f, 2, -3));//10
        vectorsList.Add(new Vector3(-7, 2, -3));//11
        vectorsList.Add(new Vector3(-4, 2, -4));//12
        vectorsList.Add(new Vector3(-3, 2, -7));//13
        vectorsList.Add(new Vector3(-3, 2, -37.5f));//14
        vectorsList.Add(new Vector3(3, 2, -37.5f));//15
        vectorsList.Add(new Vector3(3, 2, -7));//16
        vectorsList.Add(new Vector3(3.5f, 2, -4));//17
        vectorsList.Add(new Vector3(7, 2, -3));//18
        vectorsList.Add(new Vector3(37.5f, 2, -3));//19
        vectorsList.Add(new Vector3(0, 2, 0)); // 20 240 2 45
    ...
    public void GenerateNodesOn_droga_2jezdniowa(ElementDrogi element)// funkcja do generowania i łączenia nodów na droga_2jezdniowa
    {
        List<PedestrianNode> listOfNodes = new List<PedestrianNode>();
        List<Vector3> vectorsList = new List<Vector3>();// lista do przechowywanie pozycji względnej każdego noda
        vectorsList.Add(new Vector3(-7.5f,  2, 3));
        vectorsList.Add(new Vector3(7.5f,2, 3));
        vectorsList.Add(new Vector3(7.5f, 2, -3));
        vectorsList.Add(new Vector3(-7.5f, 2, -3));
